...
<meta property="fb:admins" content="1235700223" /> 
  ...
  var array2 = [["Hour","Matt Diaz","Robert Lawrence","Carter Rhodes"],["9am",4, 5, 10],["10am",21, 9, 35],["11am",37, 22, 43],["noon",58, 41, 57],["1pm",89, 64, 68],["2pm",115, 78, 85],["3pm",143, 89, 119],["4pm",167, 104, 138],["5pm",187, 117, 145],["6pm",204, 127, 166],["7pm",208, 131, 170]];
  data2 = google.visualization.arrayToDataTable(array2);
    var options = {
          colors:['#00bfff','red','#FFFF33'], backgroundColor: 'transparent', pointSize: 5, top: 0,
          vAxis: {title: '# of Votes (by hour)'},hAxis: { textStyle: {color: 'white'}},  vAxis: { title: 'Votes', titleTextStyle: {color:"white"}, textStyle: {color: 'white'}}, legend: {textStyle:{color: "white"}, position: "bottom", position: "in"}, chartArea: {top: 50}
        };
